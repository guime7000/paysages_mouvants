...
int urn1_start[3]={2, 15, 30}; // Start time offsets in min since Show is ON.
int urn1_stop[3]={3, 20, 35}; // Stop time offsets in min since Show is ON.
byte urn1_index = 0;
...
int urn2_start[2]={7, 20}; // Start time offsets in min since Show is ON.
int urn2_stop[2]={13, 23}; // Start time offsets in min since Show is ON.
byte urn2_index = 0;
...
int urn3_start[4]={0, 10, 20, 30}; // Start time offsets in min since Show is ON.
int urn3_stop[4]={5, 15, 25, 35}; // Start time offsets in min since Show is ON.
byte urn3_index = 0;
...
int urn4_start[1]={20}; // Start time offsets in min since Show is ON.
int urn4_stop[1]={50}; // Stop time offsets in min since Show is ON.
byte urn4_index = 0;
...
int urn5_start[3]={15, 20, 35}; // Start time offsets in min since Show is ON.
float urn5_stop[3]={19.95, 24.95, 35}; // Start time offsets in min since Show is ON.
